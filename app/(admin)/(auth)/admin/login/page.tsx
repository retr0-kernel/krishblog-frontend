        ...
        <div className="min-h-dvh bg-[hsl(var(--background))] flex items-center justify-center px-4">
            ...
            >
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    <div>
                        <label className="block text-xs font-sans font-medium uppercase tracking-wider text-[hsl(var(--muted-foreground))] mb-1.5">
                            Email
                        </label>
                        <input
                            type="email"
                    ...
                    {error && (
                        <p className="text-xs font-sans text-[hsl(var(--destructive))] bg-[hsl(var(--destructive)/0.08)] px-3 py-2 rounded">
                            {error}
                        </p>
                    )}
